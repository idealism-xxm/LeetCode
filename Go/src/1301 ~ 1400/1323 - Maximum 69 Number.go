...
//      并用 ansWeight 维护最后一个 6 的权重。
//
//      这样最后只需要对 num 加上 3 * ansWeight ，
//      就能达到将最后一个 6 替换为 9 的效果。
//
//
//      时间复杂度：O(n)
//          1. 需要遍历 num 中全部 O(logn) 个十进制位
//      空间复杂度：O(n)
//          1. 只需要维护常数个额外变量即可


func maximum69Number (num int) int {
    // ansWeight 表示从右到左最后一个 6 的权重。
    // 初始化为 0 ，表示还没有 6
    ansWeight := 0
