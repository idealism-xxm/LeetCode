...
impl Solution {
    pub fn is_valid_sudoku(board: Vec<Vec<char>>) -> bool {
        for i in 0..9 {
            ...
            if !Self::is_valid_row(&board, i) || !Self::is_valid_col(&board, i) {
                return false
            }
            // 计算第 i 个九宫格的左上角坐标
            let (r, c) = ((i / 3) * 3, (i % 3) * 3);
            // 如果该九宫格不合法，则直接返回 false
            if !Self::is_valid_square(&board, r, c) {
                return false
            }
        }
    ...
    fn is_valid_row(board: &Vec<Vec<char>>, r: usize) -> bool {
        // nums 维护当前行已经出现的数字
    ...
    fn is_valid_col(board: &Vec<Vec<char>>, c: usize) -> bool {
        // nums 维护当前列已经出现的数字
        let mut nums = HashSet::new();
        for r in 0..9 {
            // 如果是空，则继续
    ...
    fn is_valid_square(board: &Vec<Vec<char>>, start_r: usize, start_c: usize) -> bool {
        // nums 维护当前九宫格已经出现的数字
        let mut nums = HashSet::new();
